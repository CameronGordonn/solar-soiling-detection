...
> ⚠️ **Public mirror.** The clone URL and data-bundle steps below point at the private repository and will not work here. See [../MIRROR.md](../MIRROR.md).
...
make bootstrap
make test-fast                    # expect 558 passed, 3 skipped, 2 deselected
```
